 ...
 * - QUICKBOOKS_REDIRECT_URI (or http://localhost:8000/callback if unset) must be registered as a redirect URI in your Intuit app
 */
...
async function main() {
  ...
  try {
    ...
    console.error('3. QUICKBOOKS_REDIRECT_URI (or http://localhost:8000/callback if unset) is registered as a redirect URI in your Intuit app');
